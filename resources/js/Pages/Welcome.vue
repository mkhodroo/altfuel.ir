...
import 'https://cdn.jsdelivr.net/npm/jquery@3.6.3/dist/jquery.slim.min.js';
...
<template>
    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right" style="direction: rtl;">
